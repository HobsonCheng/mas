...
class DSRefresh: UIView, ESRefreshProtocol, ESRefreshAnimatorProtocol {
    ...
    private let imageView: UIImageView = {
        ...
        imageView.image = UIImage.init(named: "icon_wechat.png")
        imageView.sizeToFit()
    ...
    func startAnimating() {
        if timer == nil {
            timer = Timer.scheduledTimer(timeInterval: 0.01, target: self, selector: #selector(DSRefresh.timerAction), userInfo: nil, repeats: true)
